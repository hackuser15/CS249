NOTE : Since all packages can be smoothly installed on Mac OS (as compared to Windows/Ubuntu machine), it is
recommended to run it on Mac.



1.The modified training dataset is present in training-annotated-text.json & testing dataset is present in testing-annotated-text.json
...
Note : Due to known issues of Jython incompatibility with Python IDEs such as Pycharm, we need to install it and use it
separately as described in the steps for running model below)
